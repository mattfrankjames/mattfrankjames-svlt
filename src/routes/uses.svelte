...
<svelte:head>
  <title>Matt Frank James | Uses</title>
</svelte:head>

<div class="container">
  <h1>/uses</h1>
  <div class="content-wrapper">
    <img src="/desk.jpg" loading="lazy" alt="My desk" />
    <div class="content-wrapper__text-block">
      ...
      <ul>
        ...
        <li>
          <a
            href="https://www.amazon.com/gp/product/B07Q44L76B/ref=ppx_yo_dt_b_asin_title_o08_s00?ie=UTF8&psc=1">Amazon
            Basic High Back Mesh Chair</a><br />I bought because it was cheap and I thought working
          from home would be temporary. It's pretty comfortable but I wish I'd just popped for the
          Aeron at the time.
        </li>
        <li>
          <a
            href="https://www.amazon.com/gp/product/B00XEOSUBK/ref=ppx_yo_dt_b_asin_title_o04_s00?ie=UTF8&psc=1">Samdi
      ...
      <ul>
        <li>16" MacBook Pro 32gb RAM, i7 6-core processor</li>
        <li>Space Grey Magic Keyboard with number pad</li>
        <li>Space Grey Magic Trackpad</li>
        <li>Black Magic Mouse</li>
      </ul>
      <h2>Phone, tablet, gadgets</h2>
      <ul>
        <li>iPhone 11 pro</li>
        <li>iPad Pro</li>
        <li>Apple Watch</li>
      ...
      <h2>Guitars</h2>
      <ul>
        <li>Epiphone SG G400</li>
        <li>Fender Duo Sonic HS</li>
        <li>Yamaha acoustic</li>
        <li>Epiphone AccuBass covered in stickers from sixth grade</li>
        <li>Vox 16" combo with tube preamp</li>
        <li>Lots of ElectroHarmonix pedals</li>
      </ul>
    </div>
  </div>
</div>
